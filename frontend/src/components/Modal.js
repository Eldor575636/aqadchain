  ...
  return createPortal(
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="relative min-h-full flex items-center justify-center p-4">
        <div className={`relative w-full ${sizes[size]} bg-white rounded-card shadow-2xl flex flex-col max-h-[85vh] my-8`}>
          ...
          {footer && <div className="px-6 py-4 border-t border-gray-100 bg-gray-50 rounded-b-card flex-shrink-0">{footer}</div>}
        </div>
      </div>
    </div>,
    document.body
